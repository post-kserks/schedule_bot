...
Telegram бот для управления расписанием занятий с функциями уведомлений, контрольных мероприятий и удобным интерфейсом.
...
├── 📄 build-and-run.sh     # Скрипт развертывания
